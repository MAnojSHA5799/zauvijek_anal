...
const processCostData = {
  monthly: [
    { name: "Pattern Making", past: 487.5, current: 195, monthlySaving: 438750, yearlySaving: 5265000 },
    { name: "Mold Preparation", past: 731.25, current: 325, monthlySaving: 609375, yearlySaving: 7312500 },
    { name: "Assembly of Mold & Gating", past: 487.5, current: 195, monthlySaving: 438750, yearlySaving: 5265000 },
    { name: "Metal Melting", past: 10968.75, current: 9587.5, monthlySaving: 2071875, yearlySaving: 24862500 },
    { name: "Tapping", past: 1000, current: 562.5, monthlySaving: 656250, yearlySaving: 7875000 },
    { name: "Purification", past: 975, current: 568.75, monthlySaving: 609375, yearlySaving: 7312500 },
    { name: "Pouring", past: 1137.5, current: 731.25, monthlySaving: 609375, yearlySaving: 7312500 },
    { name: "Rough Casting", past: 528.13, current: 284.38, monthlySaving: 365625, yearlySaving: 4387500 },
    { name: "Cooling", past: 365.63, current: 219.38, monthlySaving: 219375, yearlySaving: 2632500 },
    { name: "Solidification", past: 146.25, current: 73.13, monthlySaving: 109688, yearlySaving: 1316250 },
    { name: "Risers", past: 113.75, current: 56.88, monthlySaving: 85313, yearlySaving: 1023750 },
    { name: "Shakeout", past: 73.13, current: 40.63, monthlySaving: 48750, yearlySaving: 585000 },
    { name: "Mold Breaking (Shot Blasting)", past: 105.63, current: 56.88, monthlySaving: 73125, yearlySaving: 877500 },
    { name: "Fettling & Finishing", past: 178.75, current: 105.63, monthlySaving: 109688, yearlySaving: 1316250 },
  ],
  yearly: [
    { name: "Pattern Making", past: 5850, current: 2340, monthlySaving: 438750, yearlySaving: 5265000 },
    { name: "Mold Preparation", past: 8775, current: 3900, monthlySaving: 609375, yearlySaving: 7312500 },
    { name: "Assembly of Mold & Gating", past: 5850, current: 2340, monthlySaving: 438750, yearlySaving: 5265000 },
    { name: "Metal Melting", past: 131625, current: 115050, monthlySaving: 2071875, yearlySaving: 24862500 },
    { name: "Tapping", past: 12000, current: 6750, monthlySaving: 656250, yearlySaving: 7875000 },
    { name: "Purification", past: 11700, current: 6825, monthlySaving: 609375, yearlySaving: 7312500 },
    { name: "Pouring", past: 13650, current: 8775, monthlySaving: 609375, yearlySaving: 7312500 },
    { name: "Rough Casting", past: 6337.5, current: 3412.5, monthlySaving: 365625, yearlySaving: 4387500 },
    { name: "Cooling", past: 4387.5, current: 2632.5, monthlySaving: 219375, yearlySaving: 2632500 },
    { name: "Solidification", past: 1755, current: 877.5, monthlySaving: 109688, yearlySaving: 1316250 },
    { name: "Risers", past: 1365, current: 682.5, monthlySaving: 85313, yearlySaving: 1023750 },
    { name: "Shakeout", past: 877.5, current: 487.5, monthlySaving: 48750, yearlySaving: 585000 },
    { name: "Mold Breaking (Shot Blasting)", past: 1267.5, current: 682.5, monthlySaving: 73125, yearlySaving: 877500 },
    { name: "Fettling & Finishing", past: 2145, current: 1267.5, monthlySaving: 109688, yearlySaving: 1316250 },
  ],
};
...
const processData = [
  ...
  { name: "Tapping", manual: 90.0, zauvijek: 50.63 },
    ...
    <div className="min-h-screen bg-gray-100 p-6 mb-5">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-3">
        ...
        <div className="bg-gradient-to-r from-gray-700 to-gray-500 p-3 rounded-xl text-white shadow">
          ...
          <div className="text-sm">₹2,032,423.77</div>
        </div>
        ...
        <div className="bg-gradient-to-r from-sky-700 to-sky-500 p-3 rounded-xl text-white shadow">
          ...
          <div className="text-sm">₹1,980,949.41</div>
        </div>
        ...
        <div className="bg-gradient-to-r from-rose-600 to-red-500 p-3 rounded-xl text-white shadow">
          ...
          <div className="text-sm">~6.78%</div>
        </div>
        ...
        <div className="bg-gradient-to-r from-emerald-600 to-emerald-400 p-3 rounded-xl text-white shadow">
          ...
          <div className="text-sm">402.33 kg</div>
        </div>
        ...
        <Col xs={12} md={8}>
          <div className="md:col-span-2">
            <div className="bg-white rounded-xl p-6 shadow-md h-[350px]">
              ...
              <ResponsiveContainer width="100%" height={200}>
                <BarChart
                  data={processCostData[filter as "monthly" | "yearly"]}
                >
                  <XAxis
                    dataKey="name"
                    tick={{ fontSize: 11 }}
        ...
        <Col>
          <div className="bg-white rounded-xl p-4 shadow-md h-[420px]">
            <h4 className="h6 mb-3">
              Electricity Consumption: Before vs After Zauvijek
            </h4>
            <ResponsiveContainer width="100%" height={400}>
              <BarChart
