...
import { Hammer, IndianRupee, TrendingUp, Zap, PiggyBank, Calendar } from "lucide-react"
...
export default function ShakeoutCharts() {
  const [formData, setFormData] = useState<ShakeoutData>({
    processName: "Shakeout",
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-[#0f1422] text-black dark:text-white p-6 mb-5 transition-colors duration-300">
      ...
      {/* Header */}
      <div className="mb-6">
        <h1 className="text-3xl font-bold text-gray-800 dark:text-white mb-2">Shakeout Process Analytics</h1>
        <p className="text-gray-600 dark:text-gray-400">
          Performance metrics and cost analysis for the Shakeout manufacturing process
        </p>
      </div>
...
<Card className="mb-8 bg-white dark:bg-[#1c2331]">
        <CardHeader>
          <CardTitle className="text-xl font-bold text-gray-800 dark:text-white">
            Shakeout Process Configuration
          </CardTitle>
        </CardHeader>
        <CardContent>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-7 gap-8 mb-8">
        ...
        <div className="lg:col-span-5 bg-white dark:bg-[#1c2331] p-6 rounded-xl shadow-lg">
          <h2 className="text-xl font-semibold mb-4 text-gray-800 dark:text-white">
            Monthly Performance Trends - Shakeout Process
          </h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="bg-white dark:bg-[#1c2331] p-6 rounded-xl shadow-lg">
          <h2 className="text-xl font-semibold mb-4 text-gray-800 dark:text-white">Shakeout Efficiency Metrics</h2>
          <div className="space-y-4">
            ...
            <div className="flex justify-between items-center p-3 bg-emerald-50 dark:bg-emerald-900/20 rounded-lg">
              <span className="text-gray-700 dark:text-gray-300">Sand Recovery Rate</span>
      ...
      {/* Shakeout Summary */}
      <div className="mt-8 bg-gradient-to-r from-amber-50 to-yellow-50 dark:from-amber-900/20 dark:to-yellow-900/20 p-6 rounded-xl shadow-lg">
        <h3 className="text-xl font-bold text-gray-800 dark:text-white mb-4">🔨 Shakeout Process Impact Summary</h3>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          <div className="text-center">
            <div className="text-2xl font-bold text-green-600 dark:text-green-400">₹11,863</div>
            <div className="text-sm text-gray-600 dark:text-gray-400">Annual Savings</div>
          </div>
          <div className="text-center">
            <div className="text-2xl font-bold text-blue-600 dark:text-blue-400">44.40%</div>
            <div className="text-sm text-gray-600 dark:text-gray-400">Cost Reduction</div>
          </div>
          <div className="text-center">
            <div className="text-2xl font-bold text-purple-600 dark:text-purple-400">2.92 kWh</div>
            <div className="text-sm text-gray-600 dark:text-gray-400">Energy Saved Daily</div>
          </div>
          <div className="text-center">
            <div className="text-2xl font-bold text-orange-600 dark:text-orange-400">₹32.50</div>
