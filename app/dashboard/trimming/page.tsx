...
const allData = {
  ...
  weekly: {
    ...
    co2Data: [
      { name: "Week 1", saved: 2.56 },
      { name: "Week 2", saved: 2.56 },
    ],
    pieData: [
      { name: "Before Zauvijek", value: 113.75 },
      { name: "With Zauvijek", value: 56.88 },
  ...
  monthly: {
    electricityData: [
      { name: "Trimming", before: 113.75, after: 56.88 },
    ],
    co2Data: [
      { name: "Trimming", saved: 5.12 },
    ],
    pieData: [
      { name: "Before Zauvijek", value: 113.75 },
      { name: "With Zauvijek", value: 56.88 },
  ...
  yearly: {
    electricityData: [
      { name: "Trimming", before: 1365, after: 682.56 },
    ],
    co2Data: [
      { name: "Trimming", saved: 61.44 },
    ],
    pieData: [
...
const sampleData1 = [
  { name: "Jan", production: 60, current: 30 },
  { name: "Feb", production: 55, current: 28 },
  { name: "Mar", production: 70, current: 35 },
  { name: "Apr", production: 50, current: 25 },
  { name: "May", production: 65, current: 32 },
  { name: "Jun", production: 58, current: 29 },
  { name: "Jul", production: 68, current: 34 },
  { name: "Aug", production: 72, current: 36 },
  { name: "Sep", production: 66, current: 33 },
  { name: "Oct", production: 61, current: 30 },
  { name: "Nov", production: 59, current: 29 },
  { name: "Dec", production: 63, current: 31 },
];

const COLORS = ["#F97316", "#10B981"];

export default function TrimmingViewPage() {
    ...
    <div className="space-y-4 mb-5">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-3">
        <div className="bg-gradient-to-r from-blue-600 to-blue-500 p-3 rounded-xl text-white shadow">
          ...
          <div className="text-sm">Trimming</div>
        </div>
