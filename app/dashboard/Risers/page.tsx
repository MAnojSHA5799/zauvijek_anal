...
import { Workflow, IndianRupee, TrendingUp, Zap, PiggyBank, Calendar } from "lucide-react"
...
export default function RisersCharts() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-[#0f1422] text-black dark:text-white p-6 mb-5 transition-colors duration-300">
      ...
      {/* Header */}
      <div className="mb-6">
        <h1 className="text-3xl font-bold text-gray-800 dark:text-white mb-2">Risers Process Analytics</h1>
        <p className="text-gray-600 dark:text-gray-400">
          Performance metrics and cost analysis for the Risers manufacturing process
        </p>
      </div>
 ...
 <Card className="mb-8 bg-white dark:bg-[#1c2331]">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-7 gap-8 mb-8">
        ...
        <div className="lg:col-span-5 bg-white dark:bg-[#1c2331] p-6 rounded-xl shadow-lg">
          <h2 className="text-xl font-semibold mb-4 text-gray-800 dark:text-white">
            Monthly Performance Trends - Risers Process
          </h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="bg-white dark:bg-[#1c2331] p-6 rounded-xl shadow-lg">
          <h2 className="text-xl font-semibold mb-4 text-gray-800 dark:text-white">Risers Efficiency Metrics</h2>
          <div className="space-y-4">
      ...
      {/* Risers Summary */}
      <div className="mt-8 bg-gradient-to-r from-orange-50 to-red-50 dark:from-orange-900/20 dark:to-red-900/20 p-6 rounded-xl shadow-lg">
        <h3 className="text-xl font-bold text-gray-800 dark:text-white mb-4">🔧 Risers Process Impact Summary</h3>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          <div className="text-center">
            <div className="text-2xl font-bold text-green-600 dark:text-green-400">₹20,756</div>
            <div className="text-sm text-gray-600 dark:text-gray-400">Annual Savings</div>
          </div>
          <div className="text-center">
            <div className="text-2xl font-bold text-blue-600 dark:text-blue-400">50.00%</div>
            <div className="text-sm text-gray-600 dark:text-gray-400">Cost Reduction</div>
          </div>
          <div className="text-center">
            <div className="text-2xl font-bold text-purple-600 dark:text-purple-400">5.12 kWh</div>
            <div className="text-sm text-gray-600 dark:text-gray-400">Energy Saved Daily</div>
          </div>
          <div className="text-center">
            <div className="text-2xl font-bold text-orange-600 dark:text-orange-400">₹56.88</div>
