...
import { Flame, IndianRupee, TrendingUp, Zap, PiggyBank, Calendar } from "lucide-react"
    ...
    <div className="min-h-screen bg-white dark:bg-[#0f1422] text-black dark:text-white p-6 mb-5 transition-colors duration-300">
      ...
      <div className="mb-6">
        <h1 className="text-3xl font-bold text-gray-800 dark:text-white mb-2 flex items-center gap-3">
          ...
          Heat Process Analytics
        </h1>
        <p className="text-gray-600 dark:text-gray-400">
          Performance metrics and cost analysis for the Heat manufacturing process
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-7 gap-8 mb-8">
        ...
        <div className="lg:col-span-5 bg-white dark:bg-[#1c2331] p-6 rounded-xl shadow-lg">
          <h2 className="text-xl font-semibold mb-4 text-gray-800 dark:text-white">
            Monthly Performance Trends - Heat Process
          </h2>
          <ResponsiveContainer width="100%" height={400}>
            <ComposedChart data={monthlyTrendData} margin={{ top: 20, right: 30, left: 20, bottom: 20 }}>
              ...
              <Bar dataKey="Zauvijek" fill="#F97316" name="With Zauvijek" radius={[4, 4, 0, 0]} />
              <Line
                type="monotone"
                dataKey="Saving"
                stroke="#10B981"
        ...
        <div className="bg-white dark:bg-[#1c2331] p-6 rounded-xl shadow-lg">
          ...
          <div className="space-y-4">
            <div className="flex justify-between items-center p-3 bg-orange-50 dark:bg-orange-900/20 rounded-lg">
              ...
              <span className="font-bold text-orange-600 dark:text-orange-400">₹{formData.dailySaving.toFixed(2)}</span>
            </div>
        ...
        <div className="bg-white dark:bg-[#1c2331] p-6 rounded-xl shadow-lg">
          ...
          <div className="space-y-4">
            ...
            <div className="flex justify-between items-center p-3 bg-purple-50 dark:bg-purple-900/20 rounded-lg">
              ...
              <span className="font-bold text-purple-600 dark:text-purple-400">Critical</span>
            </div>
          </div>
        </div>
      </div>
